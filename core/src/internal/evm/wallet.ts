...
function newEvmWalletState(): PartialWithDiscriminant<
	EvmWalletProps,
	"isConnected"
> {
	return {
...
export type EvmWalletApi = {
	connect(
		key: EvmExtensionKey,
		config?: Partial<WalletConfig & ConnectEvmWalletCallbacks>,
	): void;
	connectAsync: (
		key: EvmExtensionKey,
...
export type EvmWalletState<
	TKeys extends keyof EvmWalletProps = keyof EvmWalletProps,
> = PartialWithDiscriminant<EvmWalletProps, "isConnected", TKeys>;

export type ConnectedEvmWalletState = Extract<
	EvmWalletState,
	{ isConnected: true }
>;
export type DiconnectedEvmWalletState = Extract<
	EvmWalletState,
	{ isConnected: false }
>;
...
export type EvmWalletStore = Store<
	EvmWalletStoreState,
...
export const createEvmWalletStore = createStoreFactory<
	EvmWalletStoreState,
	WalletStorePersistData,
	| [EvmWalletStoreOptions]
	| [EvmWalletStoreOptions, { lifecycle?: LifeCycleManager }]
>(
	(
		setState,
		getState,
		...
		const initialState: EvmWalletStoreState &
