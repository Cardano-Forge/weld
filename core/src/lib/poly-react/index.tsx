...
const walletContext = createContextFromStore<WeldPolyInstance, "wallet">(
	"wallet",
);
...
const extensionsContext = createContextFromStore<
	WeldPolyInstance,
	"extensions"
>("extensions");
...
export type WeldPolyProviderProps = React.PropsWithChildren<
	Partial<EvmConfig>
> & {
