...
export type AddressHex =
	`${ChangeAddressHexPrefix | StakeAddressHexPrefix}${string}`;
...
export type StakeAddressBech32Prefix =
	(typeof stakeAddressBech32Prefixes)[number];

const changeAddressBech32Prefixes = ["addr", "addr_test"] as const;
export type ChangeAddressBech32Prefix =
	(typeof changeAddressBech32Prefixes)[number];

export type AddressBech32 =
	`${StakeAddressBech32Prefix | ChangeAddressBech32Prefix}${string}`;
