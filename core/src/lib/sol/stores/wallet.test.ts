...
const publicKeyBytes = Uint8Array.from([
	27, 245, 253, 95, 185, 95, 232, 136, 100, 224, 148, 51, 194, 98, 149, 47, 221,
	73, 24, 156, 127, 46, 65, 230, 189, 44, 146, 206, 218, 188, 212, 169,
]);
...
describe("send", () => {
	...
	it("should send currency with the appropriate units", async () => {
		...
		expect(signAndSendTransactionSpy).toHaveBeenLastCalledWith(
			res2.transaction,
		);
