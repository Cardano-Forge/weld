			...
			<WeldProvider plugins={[...builtinPlugins, hodeiPlugin()]}>
				<ExampleContainer>
					...
					<p className="max-w-[800px] mx-auto text-center my-8">
						These samples are not intended as UI demonstrations; they are
						provided to help understand functionalities and code. If you are not
						a developer, these examples may not be applicable to you.
					</p>
