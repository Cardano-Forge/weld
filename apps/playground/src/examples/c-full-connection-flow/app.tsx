			...
			<article className="card bg-base-100 shadow-xl">
				<div className="card-body">
					...
					<div className="grid md:grid-cols-2 md:gap-8">
						<div>
							<p className="text-sm">
								The wallet state includes the data that are usually displayed on
								the wallet connection component of a website, like a dropdown or
								a modal trigger. This data automatically updates in response to
								wallet events.
							</p>
							...
							<ul>
								<li className="ml-4 mt-2">
									...
									<div className="text-xs">
										Initiate a connection to view your wallet data
									</div>
								</li>
								<li className="ml-4 mt-2">
									<h4>Switch the network</h4>
									<div className="text-xs">
										The network, addresses, and balance should automatically
										update.
									</div>
								</li>
								<li className="ml-4 mt-2">
									...
									<div className="text-xs">
										You should observe that all relevant data updates
										dynamically with the new connection.
									</div>
								</li>
								<li className="ml-4 mt-2">
